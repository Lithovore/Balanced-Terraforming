...
PlaceObj('ModItemBuildingTemplate', {
	...
	'template_class', "RDM_GeoPowerPlant",
	'pin_rollover_context', "electricity",
	'pin_rollover_hint', T(400692736150, --[[ModItemBuildingTemplate sGeoPowerPlant pin_rollover_hint]] "<image UI/Infopanel/left_click.tga 1400> Select"),
	'pin_rollover_hint_xbox', T(167545854788, --[[ModItemBuildingTemplate sGeoPowerPlant pin_rollover_hint_xbox]] "<image UI/PS4/Cross.tga> View"),
	'construction_cost_Concrete', 25000,
	'construction_cost_MachineParts', 15000,
	'build_points', 5000,
	'is_tall', true,
	'dome_forbidden', true,
	'upgrade1_id', "sGeoPowerPlant_AdvancedTurbine",
	'upgrade1_display_name', T(785141562533, --[[ModItemBuildingTemplate sGeoPowerPlant upgrade1_display_name]] "Advanced Turbine"),
	'upgrade1_description', T(1337001, --[[ModItemBuildingTemplate sGeoPowerPlant upgrade1_description]] "+<upgrade1_mul_value_1>% Power Production."),
	'upgrade1_icon', "UI/Icons/Upgrades/automation_01.tga",
	'upgrade1_upgrade_cost_MachineParts', 15000,
	'upgrade1_mod_label_1', "sGeoPowerPlant",
	'upgrade1_mod_prop_id_1', "electricity_production",
	'upgrade1_mul_value_1', 100,
	'upgrade1_mod_label_2', "sGeoPowerPlant",
	'maintenance_resource_amount', 2000,
	'display_name', T(180155409982, --[[ModItemBuildingTemplate sGeoPowerPlant display_name]] "Geothermal Power Plant"),
	'display_name_pl', T(524079652714, --[[ModItemBuildingTemplate sGeoPowerPlant display_name_pl]] "Geothermal Power Plants"),
	'description', T(883805753506, --[[ModItemBuildingTemplate sGeoPowerPlant description]] "Generates lot of energy and a small heat area. It requires 5 Engineers and water to work."),
...
PlaceObj('ModItemCode', {
	'name', "Class_sBuilding_GeoPowerPlant",
	'comment', "[depreciated]",
	'FileName', "Code/Class_sBuilding_GeoPowerPlant.lua",
}),
PlaceObj('ModItemCode', {
	'name', "Init",
